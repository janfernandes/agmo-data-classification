...
def aplicar_regra(X_train, y_train, regra):
    ...
    objtive_1 = sensitivity * specificity
...
def generate_ind():
    ...
    return [[np.random.randint(2), np.random.randint(11), np.random.randint(11)] for _ in range(GENOME_SIZE)]
...
GENOME_SIZE = 9
LIMIAR = 7
CLASSE = 2 # neste caso sao as 2 e a 4
