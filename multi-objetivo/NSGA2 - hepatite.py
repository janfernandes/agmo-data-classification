...
class DataMiningProblem(Problem):
    ...
    def __init__(self, n_obj=2, n_genes=18):
    ...
    def _evaluate(self, individuo_rep, out, *args, **kwargs):
        ...
        out["F"] = np.array([- objetivo_1, - objetivo_3, - objetivo_4], dtype=np.float)
...
class DataMiningSampling(Sampling):
    ...
    def _do(self, problem, n_samples, **kwargs):
        ...
        for i in range(n_samples):
            for j in range(problem.n_characters):
                X[i, 0] = self.generate_ind(problem)

        return X

    def generate_ind(self, problem):
        ind = [[np.random.randint(2), np.random.randint(11), np.random.randint(2)] for _ in range(problem.n_characters)]
...
def plotar_quatro_objetivos():
    ...
    plt.savefig('C:\\Users\\ferna\\OneDrive\\Imagens\\gina\\result-derma-1-2-3-4-classe-' + str(CLASSE) + '.png')
    plt.show()
...
def plotar_dois_objetivos():
    ...
    plt.savefig('C:\\Users\\ferna\\OneDrive\\Imagens\\gina\\result-hepatite-1-4-classe-' + str(CLASSE) + '.png')
    plt.show()


# plotar_dois_objetivos()
...
def plot_tres_objetivos():
    ...
    ax.set_xlabel('Objetivo 1')
    ax.set_ylabel('Objetivo 3')
    ax.set_zlabel('Objetivo 4')

    plt.savefig('C:\\Users\\ferna\\OneDrive\\Imagens\\gina\\result-hepatite-1-3-4-classe-' + str(CLASSE) + '.png')
    plt.show()
