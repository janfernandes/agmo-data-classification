...
class DataMiningProblem(Problem):
    ...
    def __init__(self, n_obj=2, n_genes=34):
...
def plotar_dois_objetivos():
    ...
    plt.plot(x_pareto, y_pareto, color='xkcd:dusty lavender', alpha=.2)
    plt.scatter(x_all, y_all, color='xkcd:purple red')
    plt.xlabel('Objetivo 1')
    plt.ylabel('Objetivo 4')
    plt.savefig('C:\\Users\\ferna\\OneDrive\\Imagens\\gina\\result-derma-1-4-classe-' + str(CLASSE) + '.png')
    # plt.show()
...
def plot_tres_objetivos():
    ...
    plt.savefig('C:\\Users\\ferna\\OneDrive\\Imagens\\gina\\result-derma-1-3-4-classe-' + str(CLASSE) + '.png')
    # plt.show()
